...
/// Convenience class for creating transactions on EOS-based blockchains. Once you set properties (`rpcProvider` etc.), you don't have to set them again in order to create a new transaction.

...
public extension String {
    ...
    /// Returns a tuple breaking an EOS key formatted xxx_xx_xxxxxxx into components.
...
public extension Data {
    ...
    /// Returns an EOS public key as a string formatted PUB_R1_xxxxxxxxxxxxxxxxxxx.
    ...
    /// Returns an EOS public key as a string formatted PUB_K1_xxxxxxxxxxxxxxxxxxx.
    ...
    /// Returns a legacy EOS public key as a string formatted EOSxxxxxxxxxxxxxxxxxxx.
    var toEosioLegacyPublicKey: String {
        let check = RIPEMD160.hash(message: self).prefix(4)
        return "EOS" + (self + check).base58EncodedString
    }

    /// Returns an EOS public key as a string formatted PUB_[curve]_xxxxxxxxxxxxxxxxxxx.
    ...
    /// Returns an EOS signature as a string formatted SIG_R1_xxxxxxxxxxxxxxxxxxx.
    ...
    /// Returns an EOS signature as a string formatted SIG_K1_xxxxxxxxxxxxxxxxxxx.
    ...
    /// Returns an EOS private key as a string formatted PVT_R1_xxxxxxxxxxxxxxxxxxx
    ...
    /// Returns an EOS private key as a string formatted PVT_K1_xxxxxxxxxxxxxxxxxxx
    var toEosioK1PrivateKey: String {
        return "PVT_K1_" + self.addPrefix(0x80).append4ByteDoubleSha256Suffix.base58EncodedString
    }

    /// Init data signature from EOS R1 signature string.
    ...
    /// Init data signature from EOS signature string.
    ...
    /// Create a Data object in compressed ANSI X9.63 format from an EOS public key.
    ...
    /// Create a Data object from an EOS private key.

...
public struct EosioName: Codable, CustomStringConvertible, Equatable, Hashable {
    ...
    /// Init with a String.
    ///
    /// - Parameter name: An EOS name as a string.
    /// - Throws: If not a valid EOS name.
...
public extension String {
    ...
    /// - Returns: `true` if a string is a valid EOS name.
